...
const Deals = ({navigation}) => (
  ...
  >
    <TabTop.Screen 
    name="All Deals" component={AllDeals}></TabTop.Screen>
    <TabTop.Screen name="Electronics" component={Eletronics}></TabTop.Screen>
    <TabTop.Screen name="home and Garden" component={HomeAndGarden}></TabTop.Screen>
    <TabTop.Screen name="AllDeals4" title component={ToysAndGame}></TabTop.Screen>
  </TabTop.Navigator>
);
...
export default function DealsScreen() {
  return (
    ...
    >
      ...
      name="Hot Deals" component={Deals}></Stack.Screen>
    </Stack.Navigator>
  );
}
